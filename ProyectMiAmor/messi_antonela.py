...
player_image = pygame.image.load(r"C:\ProyectMiAmor\imgs\yo.jpg")
player_image = pygame.transform.scale(player_image, (60, 60))

bullet_image = pygame.image.load(r"C:\ProyectMiAmor\imgs\corazón.png")
bullet_image = pygame.transform.scale(bullet_image, (50, 50))

enemy_image = pygame.image.load(r"C:\ProyectMiAmor\imgs\mor.jpg")
enemy_image = pygame.transform.scale(enemy_image, (60, 60))

background_image = pygame.image.load(r"C:\ProyectMiAmor\imgs\fondo_amor.jpg")
